...
function Hero({heroData,heroCount,setHeroCount}) {
  return (
    <div className='w-[40%] h-[100%]  relative' >
        <div className='absolute  text-[#88d9ee]  text-[15px] md:text-[35px] lg:text-[50px] md:left-[10%] md:top-[70px] lg:top-[100px] left-[10%] top-[10px]'>
            <p>{heroData.text1}</p>
            <p>{heroData.text2}</p>
        </div>
        <div className='absolute md:top-[350px]   lg:top-[450px] top-[120px] left-[10%] flex items-center justify-center gap-[10px] '>
