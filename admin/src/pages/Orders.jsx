  ...
  return (
    <div className='w-[99vw] min-h-[100vh] bg-gradient-to-l from-[#141414] to-[#0c2025] text-[white]'>
      ...
      <div className='w-[100%] h-[100%] flex items-center lg:justify-start justify-center'>
        <Sidebar/>
        <div className='lg:w-[85%] md:w-[70%] h-[100%] lg:ml-[310px] md:ml-[250px] mt-[20px] flex flex-col gap-[30px] overflow-x-hidden py-[50px] ml-[90px]'>
          <div className='w-[400px] h-[40px] text-[28px] md:text-[40px] mb-[20px] text-white'>All Orders List</div>
          {
           orders.map((order,index)=>(
            ...
            <div>
              <div className='flex items-start justify-center flex-col gap-[5px] text-[14px] text-[#56dbfc]'>
                {
              ...
              <div className='text-[12px] text-green-100'>
            ...
            <div className='text-[14px] text-green-100'>
                  ...
                  <p>Date : {new Date(order.date).toLocaleDateString()}</p>
                   <p className='text-[18px] text-[white]'> ₹ {order.amount}</p>
                </div>
