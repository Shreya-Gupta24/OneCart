    ...
    return (
        <div className='w-[100vw] h-[100vh] bg-gradient-to-l from-[#141414] to-[#0c2025] text-[white] flex flex-col items-center justify-start'>
            ...
            <div className='w-full h-[50px] flex items-center justify-center flex-col'>
                ...
                <span className='text-[16px] mb-8'>Welocome to OneCart, Login to continue</span>
            </div>
            <div className='max-w-[400px] w-[90%] h-[300px] bg-[#00000025] border-[1px] border-[#96969635] backdrop:blur-2xl rounded-lg shadow-lg flex items-center justify-center'>
                <form action="" className='w-[90%] h-[90%] flex flex-col items-center justify-start gap-[15px] mt-[16px]'>
                    <div className='w-[90%] h-[250px] flex flex-col items-center justify-center gap-[10px]  relative '>
                        ...
                        {!show &&<IoEyeOutline className='w-[18px] h-[18px] cursor-pointer absolute right-[5%] bottom-[50.5%]' onClick={()=>setShow(prev => !prev)}/>}
                        {show && <IoEye className='w-[18px] h-[18px] cursor-pointer absolute right-[5%] bottom-[50.5%]' onClick={()=>setShow(prev => !prev)}/>}
                        <button className='w-[100%] h-[45px] bg-[#6060f5] rounded-lg flex items-center justify-center mt-[20px] text-[17px] font-semibold' onClick={handleLogin}>Login</button>
                    </div>
                </form>
            </div>
        </div>
