...
function Add() {
  ...
  return (
    ...
    <div className='w-[82%] h-[100%] flex items-center justify-start overflow-x-hidden absolute  right-0 bottom-[5%] px-[10px]'>

      <form action="" onSubmit={handleAddProduct} className='w-[100%] md:w-[90%] h-[100%]  mt-[10px] flex flex-col gap-[15px] py-[90px] px-[30px] md:px-[30px]'>
       ...
       <button className='w-[140px] px-[10px] py-[10px] rounded-xl bg-[#65d8f7] flex items-center justify-center gap-[10px] text-black active:bg-slate-700 active:text-white active:border-[2px] border-white'>{loading ? <Loading /> : "Add Product"}</button>
